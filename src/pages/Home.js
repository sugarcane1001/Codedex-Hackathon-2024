...
const Home = () => {
  return (
    ...
    <div className="horizontal-box">
      <h1>OUR STORY</h1>
      Founder, Jonathan Li, shares a passion for board games, boba, and delicious food, so he combined them all to become Sip & Play, Park Slope’s 
        first board game cafe.  It is a straightforward concept, come in with your friends and family to play any board game from our library of 300+ games!
    ...
    <div className="vertical-boxes">
      <div className="vertical-box">
        ...
        <b>Renting the Entire Backroom:</b> <br></br>
